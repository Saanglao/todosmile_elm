...
var $author$project$Main$Todo = F3(
	function (id, text, isDone) {
		return {B: id, H: isDone, ak: text};
	});
var $elm$core$Basics$True = 0;
var $author$project$Main$todos = _List_fromArray(
	[
		A3($author$project$Main$Todo, 0, 'Dinner at John\'s', false),
		A3($author$project$Main$Todo, 1, 'Mom\'s birthday soon', false),
		A3($author$project$Main$Todo, 2, 'Call Jerry asap!', false),
		A3($author$project$Main$Todo, 3, 'Meeting at Dublin on Saturday', true),
		A3($author$project$Main$Todo, 4, 'Feed the dog', false),
		A3($author$project$Main$Todo, 5, '', false),
		A3($author$project$Main$Todo, 6, 'www.littlescrawl.com', false),
		A3($author$project$Main$Todo, 7, 'Thank you', false),
		A3($author$project$Main$Todo, 8, '', false)
	]);
var $author$project$Main$init = {p: '', g: $author$project$Main$todos};
				...
				return _Utils_update(
					model,
					{
						g: A2(
							$elm$core$List$map,
							function (x) {
								return _Utils_eq(x.B, id) ? _Utils_update(
									x,
									{H: !x.H}) : x;
							},
							model.g)
...
var $author$project$Main$appHeader = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Do it with Elm!')
				]))
		]));
var $author$project$Main$AddText = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Main$appInput = function (model) {
	return A2(
		$elm$html$Html$input,
		_List_fromArray(
			[
				...
				$elm$html$Html$Events$onInput($author$project$Main$AddText),
...
var $author$project$Main$RemoveTodo = function (a) {
	return {$: 2, a: a};
};
...
var $author$project$Main$todoList = function (model) {
	return A2(
		$elm$html$Html$ul,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('todos-container')
			]),
		A2(
			$elm$core$List$map,
			function (l) {
				return A2(
					...
					_List_fromArray(
						[
							...
							$author$project$Main$ToggleTodo(l.B)),
							$elm$html$Html$Events$onDoubleClick(
							$author$project$Main$RemoveTodo(l.B))
						]),
					_List_fromArray(
						[
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$appHeader,
				$author$project$Main$appInput(model),
				$author$project$Main$todoList(model)
			]));
};
